...
class TestStudent(TestCase):
    ...
    def test_enroll_in_the_same_course_appends_new_nots(self):
        result = self.student_with_courses.enroll("math", ["1 + 2 = 3", "3 + 4 = 7"])

        self.assertEqual("Course already added. Notes have been updated.", result)
        self.assertEqual(self.student_with_courses.courses["math"], ["x + y = z", "1 + 2 = 3", "3 + 4 = 7"])
    ...
    def test_enroll_in_new_course_with_third_param_doesnt_add_notes_to_the_course(self):
