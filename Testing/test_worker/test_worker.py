...
class TestWorker(TestCase):
    ...
    def test_work_when_worker_has_energy(self): # his money should increase and his energy should decrease
    ...
    def test_work_when_worker_has_no_energy(self): # should raise exception
